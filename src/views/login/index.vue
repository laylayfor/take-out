<template>
    <div class="login">
        ...
        <div class="main">
            ...
            <el-form :model="formData" status-icon :rules="rules" ref="formRef" size="small" label-width="0px"
                class="login-form">
                <!-- prop 校验字段名 -->
                <el-form-item prop="account">
                    <el-input type="text" prefix-icon="iconfont icon-user" v-model="formData.account" autocomplete="off"
                        class="el-input__inner"></el-input>
                </el-form-item>
                <el-form-item prop="password">
                    <el-input :type="isPassword" prefix-icon="iconfont icon-lock" v-model="formData.password"
