        ...
        <el-card>
            ...
            <el-form inline size="mini" :model="formData">
                ...
                <el-form-item label="收件人">
                    <el-input placeholder="收件人" v-model="formData.consignee"></el-input>
                </el-form-item>
                <!-- 手机号 -->
            ...
            <el-table size="small " :data="tableData">
                ...
                <!-- 手机号 -->
                <el-table-column width="120px" prop="phone" label="手机号"></el-table-column>
                <!-- 收货人 -->
                <el-table-column prop="consignee" label="收货人"></el-table-column>
                <!-- 配送地址 -->
                <el-table-column width="120px" prop="deliverAddress" label="配送地址"></el-table-column>
                <!-- 配送时间 -->
